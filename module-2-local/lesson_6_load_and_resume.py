"""
addition to the course's module 2, part 6 to allow reloading the graph and invoking from previous conversation
"""
# %%
import sqlite3
...
# %%
display(Markdown(summary_so_far))
# %%
...
# %%
input_msg = input("ask a follow up from the summary")
# %%
new_response = invoke_and_append_message(graph, config, input_msg)

# %%
display(Markdown(new_response['summary']))
# %%
